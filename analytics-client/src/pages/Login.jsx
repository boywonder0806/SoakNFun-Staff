...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden"
      style={{ background: 'linear-gradient(145deg, #0c1917 0%, #0a3f30 55%, #0a8a66 100%)' }}>
      ...
      />
      <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-emerald-500/15 blur-[100px] pointer-events-none" />
      <div className="absolute -bottom-24 -left-24 w-96 h-96 rounded-full bg-teal-500/10 blur-[100px] pointer-events-none" />

      <div className="relative w-full max-w-sm bg-white rounded-3xl overflow-hidden animate-fade-up"
        style={{ boxShadow: '0 24px 60px rgba(2, 28, 20, 0.5), 0 0 0 1px rgba(255,255,255,0.08)' }}>

        <div className="px-8 py-8 text-center"
          style={{ background: 'linear-gradient(135deg, #0a3f30 0%, #0a8a66 60%, #0ca67a 100%)' }}>
          ...
          <p className="text-sm text-white/80 mt-1 tracking-widest uppercase">Analytics</p>
        </div>
