...
import sharedPublicRouter from './routes/sharedPublic.js';
...
// Public report links (and their optional PIN gate) — no login. Mounted ahead
// of the static/SPA catch-all below so the token route wins.
app.use(sharedPublicRouter);
